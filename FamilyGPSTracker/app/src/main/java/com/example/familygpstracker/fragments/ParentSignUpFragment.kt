...
class ParentSignUpFragment : Fragment() {

    private val directionToSignUpFragment = ParentSignUpFragmentDirections.actionSignUpFragmentToDecideUserFragment()
    ...
    private lateinit var binding: FragmentParentSignUpBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentParentSignUpBinding.inflate(layoutInflater)
        return binding.root
    }
